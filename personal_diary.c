...

{
...

                {
                    ...
                    if(strcmp(e.time,time)==0) //strcmp function compares two string and returns 0 if both strings are equal.
...

                    {
                        ...
                        strcpy(e.time,time);//this function copies the source string in destination.
...

{
        ...
        do

            {
                    ...
                    fpte = fopen ( filename, "rb" ) ; //opens a bianary file in read mode

                    if ( fpte == NULL )

                            {

                                puts ( "\nTHE RECORD DOES NOT EXIST...\n" ) ; //Show to the terminal console as a output
                ...
                printf("\n\tWHOLE RECORD OF THE DAY...[1]");

                printf("\n\tRECORD OF FIX TIME...[2]");
...
void editrecord()
{
        ...
        do

            {
                    ...
                    fpte = fopen ( filename, "rb+" ) ; //	opens a binary file in read and write mode
...

                    {
...

                        {
                            ...
                            fseek(fpte,-sizeof(customer),SEEK_CUR); //SEEK_CUR – It moves file pointer position to given location.
...

{
...

        {
                        ...
                        while(pass[i]!='\r') // \r =  is the carriage return character

                        {

                            if(pass[i]=='\b') // \b = one click of backspase 
...

{
    ...
    fp=fopen("SE","rb"); //opens a binary file in read mode

    if(fp==NULL)

    {

        fp=fopen("SE","wb");//opens a binary file in write mode
